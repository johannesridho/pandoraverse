...
class TestViewController: UIViewController {
    ...
    func showARViewController() {
        ...
        let dummyAnnotations = TestViewController.getDummyAnnotations(centerLatitude: lat, centerLongitude: lon, deltaLat: deltaLat, deltaLon: deltaLon, altitudeDelta: altitudeDelta, count: annotationCount)
    ...
    @IBAction func buttonTap(_: AnyObject) {
...
extension TestViewController {
    public class func getDummyAnnotations(centerLatitude: Double, centerLongitude: Double, deltaLat: Double, deltaLon: Double, altitudeDelta: Double, count: Int) -> [ARAnnotation]
    {
        var annotations: [ARAnnotation] = []

        srand48(2)
        for i in stride(from: 0, to: count, by: 1) {
            let location = getRandomLocation(centerLatitude: centerLatitude, centerLongitude: centerLongitude, deltaLat: deltaLat, deltaLon: deltaLon, altitudeDelta: altitudeDelta)
